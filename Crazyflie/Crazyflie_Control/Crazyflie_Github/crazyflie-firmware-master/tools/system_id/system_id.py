...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--extra", default="", help="Additional information for labeling the P-DNN_csv file"
    )
    parser.add_argument("--file", default="", help="Specific P-DNN_csv file used")
    ...
    if args.file != "":
        ...
        if extra != "":
            comb = f"{comb}_{extra}"
        files = [
            f"data/data_{mode}_{comb}_00.P-DNN_csv",
            f"data/data_{mode}_{comb}_01.P-DNN_csv",
            f"data/data_{mode}_{comb}_02.P-DNN_csv",
        ]
        combVal = "B350"
        if extra != "":
            combVal += f"_{extra}"
        filesVal = [
            f"data/data_{mode}_{combVal}_00.P-DNN_csv",
        ]
