...
plotter = UAVPlotter()
logger_dir = r'E:\test\Crazyflie\Crazyflie_Control\Simulation_Data\GroundEffect_Nokov\LeftlowerArchimedes\RecordData'
...
dt = 1 / Control_freq
hover_step_len = 800
archimedes_step_len = 5000
return_step_len = 2000
end_step_len = 200
step = hover_step_len + archimedes_step_len + return_step_len + end_step_len
...
# 负责通信、参数接管、日志记录以及调用外部 WX-PID
    ...
    # 外部 WX-PID 核心控制器与状态机
        ...
        elif mode in ['hover', 'archimedes', 'spiral_return']:
...
if __name__ == '__main__':
    ...
    filename_record = f'Crazyflie_(PID)_data_z{int(z_func * 1000)}LeftlowerArchimedes.csv'
